...
NITRO_EXPORT int8_t nitro_type_coverage_echo_nullable_bool(int32_t value, NitroError* _nitro_err);
...
NITRO_EXPORT int64_t nitro_type_coverage_async_nullable_int(int64_t value);
